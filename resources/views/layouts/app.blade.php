...
<body class="d-flex flex-column h-100">
    <div id="app">
        ...
        <footer class="py-5 bg-dark text-white footer mt-auto">
            <div class="text-center">
              <h2 class="fw-bold">Digisaha</h2>
              <p class="my-5 w-50 mx-auto">
                Jl. alamat dolor sit amet, Pademangan Barat, Jakarta Utara
              </p>
              <div class="mt-5">
                <p class="m-0">Phone: +62 xxx xxx xxxx</p>
                <p>Email: companynane@gmail.com</p>
              </div>
